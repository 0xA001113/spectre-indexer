...
pub async fn load_block_checkpoint(database: &SpectreDbClient) -> Result<String, ()> {
...
pub async fn save_checkpoint(block_hash: &String, database: &SpectreDbClient) -> Result<u64, ()> {
